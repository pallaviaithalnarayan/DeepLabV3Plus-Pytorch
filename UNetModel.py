...
class UNetModel:
    def __init__(self, img_height=128, img_width=128, img_channels=3, num_classes=6):
    ...
    def build_unet_model(self):
        ...
        # Contraction path
        c1 = Conv2D(16, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(inputs_norm)
        c1 = Dropout(0.1)(c1)
...
# Usage example:
# unet = UNetModel(img_height=128, img_width=128, img_channels=3, num_classes=6)
# unet.model.summary()
